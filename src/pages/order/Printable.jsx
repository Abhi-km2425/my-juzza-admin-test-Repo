      ...
      <div className="flex justify-between">
        <div className="w-1/2 flex flex-col">
          <span className="font-extrabold">
            Order Id : {props?.data?.order[0]._id}
          </span>
          <p>
            <span className="font-extrabold">Order Date :</span>{" "}
            {props?.data?.order[0].createdAt
              ?.split("T")[0]
              ?.split("-")
              .reverse()
              .join("-")}
          ...
          <p>
            ...
            {props?.data?.orderProducts?.length}
          </p>
        </div>
        ...
        <div className="w-1/2 flex flex-col">
          ...
          <span>
            {props?.data?.address?.houseName},{props?.data?.address?.street},{" "}
            ...
            {props?.data?.orderProducts?.map((row, i) => (
              <tr key={i} className="border-b border-black">
                ...
                <td className="py-2 px-4 text-left">
                  {row?.cartProduct?.quantity}
                </td>
                <td className="py-2 px-4 text-left">
                  ₹{row.finalPrice * row?.cartProduct?.quantity}
                </td>
              </tr>
            ))}
          </tbody>

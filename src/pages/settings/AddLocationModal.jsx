...
import { setLocationData } from "../../redux/slices/CommonDataReducer";


const AddLocationModal = ({ setModal }) => {
  ...
  const handleSubmit = async () => {
    await axiosInstance.post(addDataRoute, { name: "location", list: list })
      .then((res) => {
        toast.success("New location Added");
        dispatch(setLocationData(res?.data?.list))
        setModal(false)
      })
      .catch((error) => {
        console.log(error)
